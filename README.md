...
apigee_topology	                 | - dc-1 ms-ld-ds-0 ms,ds | apigee 角色拓撲 
                                 | - dc-1 rmp-qs-0 rmp,qs  |
                                 | - dc-1 ps-master ps     |
                                 | - dc-1 devportal dp	   | 
...
Group                   | Description
:-----------------------|:---------------------------------------------------------
apigee	                | 安裝 apigee component
                        | apigee_msip: 設定連接 management server
apigee_sso	            | 安裝 apigee sso
                        | apigee_msip: 設定連接 management server
apigee_edgeui	        | 安裝 apigee new edge ui
                        | apigee_msip: 設定連接 management server
